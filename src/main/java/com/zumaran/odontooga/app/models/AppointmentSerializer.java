...
import com.zumaran.odontooga.app.models.entity.Appointment;
...
public class AppointmentSerializer extends StdSerializer<Appointment>{
    ...
    public AppointmentSerializer() { this(null); }

    public AppointmentSerializer(Class<Appointment> t) { super(t); }
